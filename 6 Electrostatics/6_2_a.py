...
def loadDataFromFile():
    ...
    variables:
    - stepsToToleranceArray"""
    global stepsToToleranceArray, stepsToToleranceArray_1a
    with open('assets2/a.pkl', 'rb') as file:
        stepsToToleranceArray = pickle.load(file)
    with open('assets1/a.pkl', 'rb') as file:
        stepsToToleranceArray_1a = pickle.load(file)

def storeDataToFile():
    """Stores data to file from current calculation. Stores variables:
    - stepsToToleranceArray"""
    global stepsToToleranceArray
    with open('assets2/a.pkl', 'wb') as file:
...
plt.plot(nArray, stepsToToleranceArray_1a,
        ...
        color = 'c',
        zorder = 1)
plt.title(r'Steps required to reach tolerance for Gauss-Seidel relaxation')
plt.ylabel(r'steps')
plt.legend(['2.a) - Gauss-Seidel', '1.a) - first numerical method'])
...
plt.xlabel(r'$n$')
plt.ylabel(r'steps')
plt.savefig('assets2/a.png', dpi = 300)
plt.show()
