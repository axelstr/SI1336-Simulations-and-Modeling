...
def loadDataFromFile():
    ...
    variables:
    - stepsToToleranceArray_a (from 6_1_a.py)
    - stepsToToleranceArray"""
    global stepsToToleranceArray, stepsToToleranceArray_a
    with open('assets1/a.pkl', 'rb') as file:
        stepsToToleranceArray_a = pickle.load(file)
    with open('assets1/b.pkl', 'rb') as file:
...
plt.plot(nArray, stepsToToleranceArray,
        ...
        markersize = 8,
        color = 'm')
plt.legend(['a) - good initial guess', 'b) - poor initial guess'])
...
plt.xlabel(r'$n$')
plt.ylabel(r'steps')
plt.savefig('assets1/b.png', dpi = 300)
plt.show()
